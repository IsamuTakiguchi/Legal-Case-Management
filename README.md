...
| AI 秘書 | 「山田さんから電話。査定書は今週中に送るとのこと。記録して」のように日本語で頼むと、依頼者と事件を自分で調べて、記録・予定・タスクの案を作る。内容を直して「登録」を押したときだけ保存する。事務所のデータへの質問（AI 検索）も同じ画面から |
